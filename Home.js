...
function editItem(index) {
    ...
    document.getElementById("Product_Manufacturer").value =
        lsProductList[index].manufacturer;
...
function updateItem(id) {
    ...
    lsProductList[id].manufacturer = document.getElementById(
    ...
    lsProductList[id].quantity = document.getElementById(
        "Product_Quantity"
    ).value;
...
function deleteItem(index) {
    ...
    var conf = confirm(
        ...
        lsProductList[index].name +
        '" with code: ' +
        lsProductList[index].code +
        " product?"
    );
    if (conf) {
